...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="smarty-dir/templates/css/zoneEvento.css"/>
...
<div class="body-box">
  ...
  <div class="aside">
  <img src="Deep.jpg" class="img-fluid" alt="Responsive image" id="side-img">
  <div class="jumbotron jumbotron-fluid" id="nomeEvento">
    <div class="container">
      <h1 class="display-4">DEEP PURPLE</h1>
    </div>
  </div>
    </div>
