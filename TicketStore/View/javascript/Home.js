...
function setTable(risposta) {
    ...
    while(rest > 0) {
        ...
        for (let c = 0; c < 3 && c < rest; c++) {
            ...
            '<img class="card-img-top" src="/TicketStore/'+ risposta[k].path_img +'/'+ risposta[k].nome_img +'" alt="Card image cap"></a>' +
...
function setCarousel(risposta) {
    html_command = '<div class="carousel-item active">'
        +'<img class="d-block w-100" src="/TicketStore/'+risposta[0].path_img+'/'+ risposta[0].nome_img +'" alt="First slide"></div>'
        +'<div class="carousel-item">'
        +'<img class="d-block w-100" src="/TicketStore/'+risposta[1].path_img+'/'+ risposta[1].nome_img +'" alt="Second slide"></div>'
        +'<div class="carousel-item">'
        +'<img class="d-block w-100" src="/TicketStore/'+risposta[2].path_img+'/'+ risposta[2].nome_img +'" alt="Third slide"></div>';
