...
/*function getAndFill() {
    ...
    if (this.readyState == 4 && this.status == 200) {
        ...
        document.getElementById("cards-block").innerHTML = risposta[0].codev;
    }
};
    xmlhttp.open("GET","Index.php?controller=CHome&task=impostaPagina", true);
    xmlhttp.send();
}*/

function getAndFill() {
    document.getElementById("cards-block").innerHTML = "prova";
}
/*
